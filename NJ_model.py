...
with open("Models/NJ_model.json", "w") as json_file:
    json_file.write(model_json)
# serialize weights to HDF5
model.save_weights("Models/NJ_model.h5")
...
plt.title('Learning NJ COVID19 Spread with LSTM')
plt.xlabel('Days since First Case')
plt.ylabel('Number of CVID19 Cases')
plt.legend()
plt.savefig('Figures/NJ_LSTM_Test_num_cases.png')
